...
INSERT INTO `tb_log_info` VALUES ('11', '4', 'admin@webside.com', 'update', 'update[参数1，类型：UserEntity，值：(getUserInfo : UserInfo [id=9, sex=null, birthday=null, telephone=null, email=null, address=null, createTime=null])(getDescription :  管理员)(getRole : RoleEntity [id=2, name=null, key=null, status=null, description=null, createTime=null, updateTime=null, userList=null])(getCreatorName : admin)(getUserName : 管理员)(getAccountName : 254813870@qq.com)]', '2016-03-29 17:39:38');
INSERT INTO `tb_log_info` VALUES ('12', '4', 'admin@webside.com', 'update', 'update[参数1，类型：UserEntity，值：(getUserInfo : UserInfo [id=4, sex=1, birthday=Wed Feb 10 00:00:00 CST 2016, telephone=15361427685, email=admin@webside.com, address=江苏省无锡市国家软件园, createTime=null])(getRole : RoleEntity [id=1, name=null, key=null, status=null, description=null, createTime=null, updateTime=null, userList=null])(getCreatorName : admin)(getUserName : admin)]', '2016-03-29 19:05:30');
INSERT INTO `tb_log_info` VALUES ('13', '4', 'admin@webside.com', 'permission', 'permission[参数1，类型：Integer，值：][参数2，类型：String，值：(getBytes : [B@5ede3538)]', '2016-04-18 23:09:12');
INSERT INTO `tb_log_info` VALUES ('14', '4', 'admin@webside.com', 'permission', 'permission[参数1，类型：Integer，值：][参数2，类型：String，值：(getBytes : [B@61b79975)]', '2016-04-18 23:10:43');
INSERT INTO `tb_log_info` VALUES ('15', '4', 'admin@webside.com', 'permission', 'permission[参数1，类型：Integer，值：][参数2，类型：String，值：(getBytes : [B@7102a301)]', '2016-04-18 23:10:59');
INSERT INTO `tb_log_info` VALUES ('16', '4', 'admin@webside.com', 'permission', 'permission[参数1，类型：Integer，值：][参数2，类型：String，值：(getBytes : [B@6db02ba9)]', '2016-04-18 23:53:48');
